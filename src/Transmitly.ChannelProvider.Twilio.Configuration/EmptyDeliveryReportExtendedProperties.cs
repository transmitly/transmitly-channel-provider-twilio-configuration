...
namespace Transmitly.ChannelProvider.Twilio.Configuration
{
	...
	{
		public IExtendedSmsDeliveryReportProperties Sms { get; } = new EmptyExtendedSmsDeliveryReportProperties();

		public IExtendedVoiceDeliveryReportProperties Voice { get; } = new EmptyExtendedVoiceDeliveryReportProperties();
